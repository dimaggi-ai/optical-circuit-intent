# Cover artwork — optical-circuit-intent

![Amber optical fibers connect two graphite endpoints through a brushed-metal switching block.](social-preview-v1.jpg)
...
Open [repository settings](https://github.com/dimaggi-ai/optical-circuit-intent/settings),
...
Alt text: Amber optical fibers connect two graphite endpoints through a brushed-metal switching block.
...
Subject: intentional optical circuit routing. An elegant close still life of one small rectangular brushed-metal optical switching block with four clearly machined sockets, paired with two small graphite endpoint blocks. Exactly four slender amber-tinted glass-fiber cords make deliberate graceful loops between the ports, with one pair visibly crossing in the center. This is a tactile optical-routing maquette, no visible laser beams or glowing light. Fine transparent fiber, matte metal, calm chalk background, three main blocks, clear negative space.
```
